...
export default function Navbar() {
  return (
    <nav className="mx-auto leading-8 text-dark-gray">
      <ul className="my-3 grid grid-flow-row grid-cols-2 justify-center justify-items-center gap-4 gap-x-0 px-20 py-7 font-quattrocento text-sm sm:my-3 sm:flex sm:w-full sm:gap-2 sm:p-2">
        {navbar.map((item) => (
          <li
            key={item.id}
